...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NaamInOnderzoekUitgebreid :  IEquatable<NaamInOnderzoekUitgebreid>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NaamInOnderzoekUitgebreid" /> class.
        /// </summary>
        ...
        public NaamInOnderzoekUitgebreid(bool geslachtsnaam = default(bool), bool voornamen = default(bool), bool voorvoegsel = default(bool), DatumOnvolledig datumIngangOnderzoek = default(DatumOnvolledig), bool adellijkeTitelPredikaat = default(bool))
        {
        ...
        {
            return this.Equals(input as NaamInOnderzoekUitgebreid);
        }

        /// <summary>
        /// Returns true if NaamInOnderzoekUitgebreid instances are equal
        /// </summary>
        /// <param name="input">Instance of NaamInOnderzoekUitgebreid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NaamInOnderzoekUitgebreid input)
        {
            if (input == null)
                return false;
