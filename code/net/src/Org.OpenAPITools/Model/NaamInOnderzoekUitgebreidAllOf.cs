...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NaamInOnderzoekUitgebreidAllOf :  IEquatable<NaamInOnderzoekUitgebreidAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NaamInOnderzoekUitgebreidAllOf" /> class.
        /// </summary>
        /// <param name="adellijkeTitelPredikaat">adellijkeTitelPredikaat.</param>
        public NaamInOnderzoekUitgebreidAllOf(bool adellijkeTitelPredikaat = default(bool))
        {
        ...
        {
            return this.Equals(input as NaamInOnderzoekUitgebreidAllOf);
        }

        /// <summary>
        /// Returns true if NaamInOnderzoekUitgebreidAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of NaamInOnderzoekUitgebreidAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NaamInOnderzoekUitgebreidAllOf input)
        {
            if (input == null)
                return false;
